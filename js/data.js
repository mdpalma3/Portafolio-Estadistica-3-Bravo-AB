  ...
  planificacion: [
    {
      ...
      archivos: [
        { nombre: "Silabo_EstadisticaNaval_2026.pdf", tipo: "pdf", tam: "482 KB", fecha: "2026-03-02" },
      ],
    },
    {
      id: "plan-micro",
      icono: "fa-diagram-project",
      titulo: "Plan Microcurricular",
      desc: "Desglose detallado de unidades, horas y estrategias didácticas.",
      archivos: [
        { nombre: "Plan_Microcurricular_U1-U4.docx", tipo: "word", tam: "310 KB", fecha: "2026-03-02" },
      ],
    },
    {
      id: "cronograma",
      ...
      desc: "Distribución semanal de temas, talleres y evaluaciones.",
      archivos: [
        { nombre: "Cronograma_Semanal.pdf", tipo: "pdf", tam: "198 KB", fecha: "2026-03-05" },
      ],
    },
    {
      id: "calendario",
    ...
    },
    {
      ...
      titulo: "Metodología",
      desc: "Enfoque pedagógico: clases magistrales, talleres y estudio de casos.",
      archivos: [
        { nombre: "Metodologia_Curso.pdf", tipo: "pdf", tam: "140 KB", fecha: "2026-03-02" },
      ],
    },
    {
      id: "bibliografia",
  ...
  unidades: [
    {
      ...
      resumen: "Organización, tabulación y representación gráfica de datos navales.",
      carpetas: {
    ...
    },
    {
      ...
      numero: 2,
      titulo: "Probabilidad",
      resumen: "Fundamentos de probabilidad aplicados a la toma de decisiones operativas.",
      carpetas: {
    ...
    },
    {
      ...
      resumen: "Distribuciones binomial, Poisson y normal en contextos navales.",
      carpetas: {
    ...
    },
    {
      ...
      resumen: "Estimación, intervalos de confianza y pruebas de hipótesis.",
      carpetas: {
        presentaciones: [{ nombre: "U4_Inferencia_Estadistica.pdf", tipo: "pdf", tam: "1.3 MB", fecha: "2026-04-20" }],
        guias: [{ nombre: "U4_Guia_Intervalos_Confianza.docx", tipo: "word", tam: "230 KB", fecha: "2026-04-22" }],
        talleres: [{ nombre: "U4_Taller_Pruebas_Hipotesis.pdf", tipo: "pdf", tam: "320 KB", fecha: "2026-04-24" }],
        videos: [{ nombre: "Video: Pruebas de hipótesis explicadas", tipo: "enlace", tam: "—", fecha: "2026-04-21" }],
        lecturas: [],
        complementario: [{ nombre: "U4_Proyecto_Final_Lineamientos.pdf", tipo: "pdf", tam: "200 KB", fecha: "2026-04-20" }],
      },
    },
  ],
